...
title: "文章标题"
date: 2026-08-08
date_display: 2026·夏   # 可选：自定义显示日期（如模糊到季节），不填则显示完整日期
tags: [标签1, 标签2]
...
| 2026-09-03 | 插件文章重写：标题「为了不熬夜看球搓的防剧透插件」，内容按 README 重写（比分遮罩/标题替换/栏目隐藏/老球迷模式/广告倒计时 等真实功能）；`date_display` 改 26春 → 2026-春 |
| 2026-09-03 | 插件文章再精简：去掉冗长README复刻版，改成几句直接短文+链接（用户反馈"又臭又长"） |
